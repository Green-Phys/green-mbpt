...
j2c_sqrt, uniq_kpts = gdf_S.make_j3c_outcore(mydf, cell, rsgdf=False, basename='df_int', j2c_sqrt=True, exx=False)
...
class TestGDFinOvlpMetric(unittest.TestCase):
    ...
    def test_j2c(self):
        self.assertAlmostEqual(j2c_sqrt[0].sum(), 12.704477121081606, 7)
        self.assertAlmostEqual(j2c_sqrt[1].real.sum(), 16.232205688566136, 7)
        self.assertAlmostEqual(j2c_sqrt[2].real.sum(), 16.26408605151605, 7)
